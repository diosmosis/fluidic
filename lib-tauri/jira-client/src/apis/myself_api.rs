...
pub async fn change_my_password(configuration: &configuration::Configuration, password_bean: models::PasswordBean) -> Result<(), Error<ChangeMyPasswordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_password_bean = password_bean;

    let uri_str = format!("{}/api/2/myself/password", configuration.base_path);
...
pub async fn get_user(configuration: &configuration::Configuration, ) -> Result<models::UserBean, Error<GetUserError>> {

    let uri_str = format!("{}/api/2/myself", configuration.base_path);
...
pub async fn update_user(configuration: &configuration::Configuration, user_write_bean: models::UserWriteBean) -> Result<models::UserWriteBean, Error<UpdateUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
