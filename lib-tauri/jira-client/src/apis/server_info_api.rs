...
pub async fn get_server_info(configuration: &configuration::Configuration, ) -> Result<serde_json::Value, Error<GetServerInfoError>> {

    let uri_str = format!("{}/api/2/serverInfo", configuration.base_path);
