...
pub async fn get_project1(configuration: &configuration::Configuration, key: Option<&str>) -> Result<models::ErrorCollection, Error<GetProject1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_key = key;

    let uri_str = format!("{}/api/2/projectvalidate/key", configuration.base_path);
