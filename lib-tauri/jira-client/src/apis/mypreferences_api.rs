...
pub async fn get_preference(configuration: &configuration::Configuration, key: Option<&str>) -> Result<String, Error<GetPreferenceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_key = key;

    let uri_str = format!("{}/api/2/mypreferences", configuration.base_path);
...
pub async fn remove_preference(configuration: &configuration::Configuration, key: Option<&str>) -> Result<(), Error<RemovePreferenceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_key = key;
...
pub async fn set_preference(configuration: &configuration::Configuration, key: Option<&str>, body: Option<&str>) -> Result<(), Error<SetPreferenceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_key = key;
    let p_body = body;
