...
pub async fn get_all_permissions(configuration: &configuration::Configuration, ) -> Result<models::PermissionsJsonBean, Error<GetAllPermissionsError>> {

    let uri_str = format!("{}/api/2/permissions", configuration.base_path);
