...
pub struct IssueUpdateBean {
    ...
    pub history_metadata: Option<Box<models::HistoryMetadata>>,
    #[serde(rename = "properties", skip_serializing_if = "Option::is_none")]
    pub properties: Option<Vec<models::EntityPropertyBean>>,
    #[serde(rename = "transition", skip_serializing_if = "Option::is_none")]
    pub transition: Option<Box<models::TransitionBean>>,
    #[serde(rename = "update", skip_serializing_if = "Option::is_none")]
    pub update: Option<std::collections::HashMap<String, Vec<models::FieldOperation>>>,
}

impl IssueUpdateBean {
    pub fn new() -> IssueUpdateBean {
        IssueUpdateBean {
            fields: None,
