...
pub struct PagedListWrapperUserJsonBeanApplicationUser {
    ...
    pub items: Option<Vec<models::UserJsonBean>>,
...
impl PagedListWrapperUserJsonBeanApplicationUser {
    pub fn new() -> PagedListWrapperUserJsonBeanApplicationUser {
        PagedListWrapperUserJsonBeanApplicationUser {
            backing_list_size: None,
            callback: None,
            items: None,
            max_results: None,
