...
impl IssueIndexSummaryBean {
    pub fn new() -> IssueIndexSummaryBean {
        IssueIndexSummaryBean {
            count_in_archive: None,
            count_in_database: None,
            count_in_index: None,
            index_readable: None,
            last_updated_in_database: None,
            last_updated_in_index: None,
        }
    }
}
