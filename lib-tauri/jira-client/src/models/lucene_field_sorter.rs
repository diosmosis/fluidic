...
pub struct LuceneFieldSorter {
    #[serde(rename = "comparator", skip_serializing_if = "Option::is_none")]
    pub comparator: Option<serde_json::Value>,
    #[serde(rename = "documentConstant", skip_serializing_if = "Option::is_none")]
    pub document_constant: Option<String>,
}

impl LuceneFieldSorter {
    pub fn new() -> LuceneFieldSorter {
        LuceneFieldSorter {
            comparator: None,
            document_constant: None,
        }
    }
}
