...
pub struct DarkFeaturesBean {
    ...
    pub site_features: Option<std::collections::HashMap<String, models::DarkFeaturePropertyBean>>,
    #[serde(rename = "systemFeatures", skip_serializing_if = "Option::is_none")]
    pub system_features: Option<std::collections::HashMap<String, models::DarkFeaturePropertyBean>>,
}

impl DarkFeaturesBean {
    pub fn new() -> DarkFeaturesBean {
        DarkFeaturesBean {
            site_features: None,
