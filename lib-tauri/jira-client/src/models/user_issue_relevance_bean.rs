...
pub struct UserIssueRelevanceBean {
    ...
    #[serde(rename = "highestIssueInvolvementRank", skip_serializing_if = "Option::is_none")]
    pub highest_issue_involvement_rank: Option<i32>,
    #[serde(rename = "issueInvolvements", skip_serializing_if = "Option::is_none")]
    pub issue_involvements: Option<Vec<models::IssueInvolvementBean>>,
    #[serde(rename = "key", skip_serializing_if = "Option::is_none")]
    pub key: Option<String>,
    #[serde(rename = "latestCommentCreationTime", skip_serializing_if = "Option::is_none")]
...
impl UserIssueRelevanceBean {
    pub fn new() -> UserIssueRelevanceBean {
        UserIssueRelevanceBean {
            avatar_urls: None,
            display_name: None,
            email_address: None,
            highest_issue_involvement_rank: None,
            issue_involvements: None,
            key: None,
            latest_comment_creation_time: None,
            name: None,
            param_self: None,
        }
    }
