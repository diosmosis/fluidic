...
pub struct EntityTypeBean {
    #[serde(rename = "applicationTypeClassName", skip_serializing_if = "Option::is_none")]
...
impl EntityTypeBean {
    pub fn new() -> EntityTypeBean {
        EntityTypeBean {
            application_type_class_name: None,
            i18n_key: None,
            icon_url: None,
            pluralized_i18n_key: None,
        }
    }
}
