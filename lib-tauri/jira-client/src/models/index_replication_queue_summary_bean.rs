...
pub struct IndexReplicationQueueSummaryBean {
    ...
    pub last_consumed_operation: Option<Box<models::IndexReplicationQueueEntryBean>>,
    #[serde(rename = "lastOperationInQueue", skip_serializing_if = "Option::is_none")]
    pub last_operation_in_queue: Option<Box<models::IndexReplicationQueueEntryBean>>,
    #[serde(rename = "queueSize", skip_serializing_if = "Option::is_none")]
    pub queue_size: Option<i64>,
}

impl IndexReplicationQueueSummaryBean {
    pub fn new() -> IndexReplicationQueueSummaryBean {
        IndexReplicationQueueSummaryBean {
            last_consumed_operation: None,
            last_operation_in_queue: None,
            queue_size: None,
        }
    }
}
