...
pub struct ProductLicenseTo {
    #[serde(rename = "isUnlimitedNumberOfUsers", skip_serializing_if = "Option::is_none")]
    pub is_unlimited_number_of_users: Option<bool>,
    #[serde(rename = "licenseKey", skip_serializing_if = "Option::is_none")]
    pub license_key: Option<String>,
    #[serde(rename = "locale", skip_serializing_if = "Option::is_none")]
    pub locale: Option<Box<models::ProductLicenseToLocale>>,
...
impl ProductLicenseTo {
    pub fn new() -> ProductLicenseTo {
        ProductLicenseTo {
            is_unlimited_number_of_users: None,
            license_key: None,
            locale: None,
