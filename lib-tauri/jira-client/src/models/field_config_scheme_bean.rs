...
pub struct FieldConfigSchemeBean {
    ...
    pub field: Option<Box<models::FieldBean>>,
    ...
    pub issue_types: Option<Vec<models::IssueTypeJsonBean>>,
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "projects", skip_serializing_if = "Option::is_none")]
    pub projects: Option<Vec<models::ProjectBean>>,
    #[serde(rename = "self", skip_serializing_if = "Option::is_none")]
    pub param_self: Option<String>,
}

impl FieldConfigSchemeBean {
    pub fn new() -> FieldConfigSchemeBean {
        FieldConfigSchemeBean {
            all_issue_types: None,
            all_projects: None,
            default_value: None,
            description: None,
            field: None,
            field_config_ids: None,
            id: None,
            issue_types: None,
            name: None,
            projects: None,
