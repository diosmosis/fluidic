...
pub struct SprintCreateBean {
    ...
    #[serde(rename = "incompleteIssuesDestinationId", skip_serializing_if = "Option::is_none")]
...
impl SprintCreateBean {
    pub fn new() -> SprintCreateBean {
        SprintCreateBean {
            auto_start_stop: None,
            end_date: None,
            goal: None,
            incomplete_issues_destination_id: None,
            name: None,
            origin_board_id: None,
            start_date: None,
            synced: None,
            user_profile_time_zone: None,
        }
    }
}
