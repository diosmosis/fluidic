...
pub struct LinkIssueRequestJsonBean {
    ...
    pub comment: Option<Box<models::CommentJsonBean>>,
    #[serde(rename = "inwardIssue", skip_serializing_if = "Option::is_none")]
    pub inward_issue: Option<Box<models::IssueRefJsonBean>>,
    #[serde(rename = "outwardIssue", skip_serializing_if = "Option::is_none")]
    pub outward_issue: Option<Box<models::IssueRefJsonBean>>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<Box<models::IssueLinkTypeJsonBean>>,
}
