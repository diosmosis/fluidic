...
pub struct IssueBean {
    ...
    pub changelog: Option<Box<models::ChangelogBean>>,
    #[serde(rename = "editmeta", skip_serializing_if = "Option::is_none")]
    pub editmeta: Option<serde_json::Value>,
    ...
    pub operations: Option<Box<models::OpsbarBean>>,
    #[serde(rename = "properties", skip_serializing_if = "Option::is_none")]
    pub properties: Option<Box<models::PropertiesBean>>,
    ...
    pub transition_beans: Option<Vec<models::TransitionBean>>,
    #[serde(rename = "transitions", skip_serializing_if = "Option::is_none")]
    pub transitions: Option<Vec<models::TransitionBean>>,
