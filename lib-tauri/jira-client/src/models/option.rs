...
pub struct Option {
    #[serde(rename = "childOptions", skip_serializing_if = "StdOption::is_none")]
    pub child_options: StdOption<Vec<models::Option>>,
    #[serde(rename = "id", skip_serializing_if = "StdOption::is_none")]
    pub id: StdOption<i64>,
    #[serde(rename = "name", skip_serializing_if = "StdOption::is_none")]
    pub name: StdOption<String>,
    #[serde(rename = "optionId", skip_serializing_if = "StdOption::is_none")]
    pub option_id: StdOption<i64>,
    #[serde(rename = "value", skip_serializing_if = "StdOption::is_none")]
    pub value: StdOption<String>,
}
