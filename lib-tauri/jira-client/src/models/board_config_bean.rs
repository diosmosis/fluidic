...
pub struct BoardConfigBean {
    ...
    pub column_config: Option<Box<models::ColumnConfigBean>>,
    #[serde(rename = "estimation", skip_serializing_if = "Option::is_none")]
    pub estimation: Option<Box<models::EstimationConfigBean>>,
    #[serde(rename = "filter", skip_serializing_if = "Option::is_none")]
    pub filter: Option<Box<models::RelationBean>>,
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<i64>,
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "ranking", skip_serializing_if = "Option::is_none")]
    pub ranking: Option<Box<models::RankingConfigBean>>,
    #[serde(rename = "self", skip_serializing_if = "Option::is_none")]
    pub param_self: Option<String>,
    #[serde(rename = "subQuery", skip_serializing_if = "Option::is_none")]
    pub sub_query: Option<Box<models::SubqueryBean>>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
}

impl BoardConfigBean {
    pub fn new() -> BoardConfigBean {
        BoardConfigBean {
            column_config: None,
            estimation: None,
            filter: None,
