...
pub struct IndexSummaryBean {
    ...
    pub issue_index: Option<Box<models::IssueIndexSummaryBean>>,
    #[serde(rename = "nodeId", skip_serializing_if = "Option::is_none")]
    pub node_id: Option<String>,
    #[serde(rename = "replicationQueues", skip_serializing_if = "Option::is_none")]
    pub replication_queues: Option<std::collections::HashMap<String, models::IndexReplicationQueueSummaryBean>>,
    #[serde(rename = "reportTime", skip_serializing_if = "Option::is_none")]
    pub report_time: Option<String>,
}

impl IndexSummaryBean {
    pub fn new() -> IndexSummaryBean {
        IndexSummaryBean {
            issue_index: None,
            node_id: None,
            replication_queues: None,
            report_time: None,
        }
    }
}
