...
pub struct CommentJsonBean {
    ...
    pub author: Option<Box<models::UserJsonBean>>,
    ...
    pub update_author: Option<Box<models::UserJsonBean>>,
    #[serde(rename = "updated", skip_serializing_if = "Option::is_none")]
    pub updated: Option<String>,
    #[serde(rename = "visibility", skip_serializing_if = "Option::is_none")]
    pub visibility: Option<Box<models::VisibilityJsonBean>>,
}

impl CommentJsonBean {
    pub fn new() -> CommentJsonBean {
        CommentJsonBean {
            author: None,
            body: None,
            created: None,
