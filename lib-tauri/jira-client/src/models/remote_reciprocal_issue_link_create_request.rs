...
pub struct RemoteReciprocalIssueLinkCreateRequest {
    ...
    pub source: Option<Box<models::RemoteIssueLinkCreateOrUpdateRequest>>,
    #[serde(rename = "target", skip_serializing_if = "Option::is_none")]
    pub target: Option<Box<models::RemoteIssueLinkCreateOrUpdateRequest>>,
}

impl RemoteReciprocalIssueLinkCreateRequest {
    pub fn new() -> RemoteReciprocalIssueLinkCreateRequest {
        RemoteReciprocalIssueLinkCreateRequest {
            source: None,
            target: None,
        }
    }
