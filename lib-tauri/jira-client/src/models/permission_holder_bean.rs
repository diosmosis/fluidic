...
pub struct PermissionHolderBean {
    ...
    pub group: Option<Box<models::GroupJsonBean>>,
    ...
    pub project_role: Option<Box<models::ProjectRoleBean>>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    #[serde(rename = "user", skip_serializing_if = "Option::is_none")]
    pub user: Option<Box<models::UserJsonBean>>,
}

impl PermissionHolderBean {
    pub fn new() -> PermissionHolderBean {
