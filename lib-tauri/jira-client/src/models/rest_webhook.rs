...
pub struct RestWebhook {
    ...
    pub credentials: Option<models::RestWebhookCredentials>,
    ...
    pub statistics: Option<models::RestWebhookStatistics>,
    #[serde(rename = "url", skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
}

impl RestWebhook {
    pub fn new() -> RestWebhook {
        RestWebhook {
            active: None,
            configuration: None,
            credentials: None,
            ...
            name: None,
            scope_type: None,
            ssl_verification_required: None,
            statistics: None,
            url: None,
        }
    }
